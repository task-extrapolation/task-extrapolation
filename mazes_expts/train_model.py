...
def main():
    ...
    parser.add_argument("--val_period", default=1, type=int, help="how often to validate")
    parser.add_argument("--width", default=4, type=int, help="width of the network")
    parser.add_argument('--stats_file_name', type=str, help='name of the directory where stats.txt locates')
    ...
    parent_dir = '/home/author_2/project_dir/output_stats'
    target_dir = '%s_%s' % (args.stats_file_name, generate_rand_string(6))
    path = os.path.join(parent_dir, target_dir)
    os.mkdir(path)
    args.checkpoint_dir = Path(path)
